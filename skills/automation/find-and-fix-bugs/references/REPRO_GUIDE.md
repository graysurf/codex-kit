...
- Prefer a single command; name it clearly (for example: `$CODEX_HOME/skills/automation/find-and-fix-bugs/$CODEX_HOME/skills/automation/find-and-fix-bugs/scripts/repro.sh`).
