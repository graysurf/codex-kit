...
Examples:
  ...
  $CODEX_HOME/skills/tools/testing/graphql-api-testing/scripts/gql-history.sh

  # Print last entry from a specific repo/config dir
  $CODEX_HOME/skills/tools/testing/graphql-api-testing/scripts/gql-history.sh --config-dir setup/graphql
