...
This folder holds shared, non-executable implementation code used by tool skills.
...
- Suggested layout (create only what you use):
  - `skills/tools/_libs/sh/*.sh` for POSIX shell helpers
  - `skills/tools/_libs/zsh/*.zsh` for zsh helpers
  - `skills/tools/_libs/python/*.py` for python helpers
  - `skills/tools/_libs/md/*.md` for shared docs/skeletons
