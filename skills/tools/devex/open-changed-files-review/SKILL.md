...
- `$CODEX_HOME/skills/tools/devex/open-changed-files-review/$CODEX_HOME/skills/tools/devex/open-changed-files-review/$CODEX_HOME/skills/tools/devex/open-changed-files-review/scripts/open-changed-files.zsh` available.
...
3. Prefer running:
   - `$CODEX_HOME/skills/tools/devex/open-changed-files-review/$CODEX_HOME/skills/tools/devex/open-changed-files-review/$CODEX_HOME/skills/tools/devex/open-changed-files-review/scripts/open-changed-files.zsh --max-files "$max" --workspace-mode pwd -- <files...>`
...
```zsh
$CODEX_HOME/skills/tools/devex/open-changed-files-review/$CODEX_HOME/skills/tools/devex/open-changed-files-review/$CODEX_HOME/skills/tools/devex/open-changed-files-review/scripts/open-changed-files.zsh --max-files "${CODEX_OPEN_CHANGED_FILES_MAX_FILES:-50}" --workspace-mode pwd -- <files...>
```
