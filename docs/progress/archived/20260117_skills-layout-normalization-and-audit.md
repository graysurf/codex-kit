...
- 2026-01-17: Clarify template placement: Markdown files with `TEMPLATE` in the filename belong in `references/` (writing skeletons) or `assets/templates/` (file scaffolds), enforced by `$CODEX_HOME/skills/tools/devex/skill-governance/scripts/audit-skill-layout.sh`.
...
- Skill layout enforcement exists and passes in CI: `$CODEX_HOME/skills/tools/devex/skill-governance/scripts/audit-skill-layout.sh`.
...
- CI-enforced layout audit: `$CODEX_HOME/skills/tools/devex/skill-governance/scripts/audit-skill-layout.sh`.
...
- Risk: broken docs/CI/scripts due to stale `template/` path references.
  - Mitigation: update all tracked references and add CI coverage (`$CODEX_HOME/skills/tools/devex/skill-governance/scripts/audit-skill-layout.sh` + existing smoke tests).
...
- [x] Step 1: Implementation (skill layout + path migration)
  ...
  - Exit Criteria:
    ...
    - [x] Skill layout audit passes: `$CODEX_HOME/skills/tools/devex/skill-governance/scripts/audit-skill-layout.sh`.
...
- `$CODEX_HOME/skills/tools/devex/skill-governance/scripts/audit-skill-layout.sh`: Enforces tracked skill directory layout (`SKILL.md` + optional `scripts/`, `references/`, `assets/`).
